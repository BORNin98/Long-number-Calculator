...
// NUM.reverse(); -> reverse the digits in the number
 ...
 /* class functionalities
	1. memory allocation -> use buffer length instead of allocating and reallocating memory for each change in the num_length
	2. constructors 
		- default -> set number to null and num_length = 0
		- copy constructor -> copys the NUM passed 
		- 
  */
